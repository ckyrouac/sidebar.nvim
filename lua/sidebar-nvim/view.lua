...
M.View = {
    ...
    winopts = {
        ...
        winhl = table.concat({
          ...
          "CursorLineNr:SidebarNvimCursorLineNr",
          "LineNr:SidebarNvimLineNr",
          "WinSeparator:SidebarNvimWinSeparator",
          "StatusLine:SidebarNvimStatusLine",
          "StatusLineNC:SidebarNvimStatuslineNC",
          "SignColumn:SidebarNvimSignColumn",
          "Normal:SidebarNvimNormalBG",
          "NormalNC:SidebarNvimNormalNC",
          "NormalFloat:SidebarNvimNormalFloat",
        }, ","),
    },
    bufopts = {
